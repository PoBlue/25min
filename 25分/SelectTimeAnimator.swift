...
class SelectTimeAnimator:NSObject, UIViewControllerAnimatedTransitioning{
    ...
    func animateTransition(transitionContext: UIViewControllerContextTransitioning) {
        ...
        let initViewframe = CGRect(x: 0, y: 0 - initViewHight, width: CGRectGetWidth(containerFrame), height: initViewHight)
